<?php
    ...
    $copywriter = $controller->model_copywriter->buscar_copywriter($id);
...
?>
<div class="copywriter-blocos <?=(!$tipo_corte && $background_color?'back ':($tipo_corte?$tipo_corte:' margin '))?> modelo-<?=$copywriter['modelo']?>" style="<?=($background_color?$background_color:'')?>" id="copywriter-<?=$id?>">
    <div class="container">
